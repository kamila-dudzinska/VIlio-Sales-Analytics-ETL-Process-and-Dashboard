...
Opis projektu: projekt przygowany od A do Z- czyli os połączenia danych do Excela i załadowaniu ich do Power Bi poprzez Power Query. Następnie przegląd tabel, dodanie kolumn obliczeniowych, określenie modelu danych - relacje między tabelami i kardynalność, utworzenie miar do wizualizacji oraz opracowanie płótna raportu.
